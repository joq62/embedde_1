...
add_info_test()->
    ...
    ok=sd_service:add_service("ServiceId_1",WorkerPod),
    ok=sd_service:add_service("ServiceId_1",WorkerPod_2),
    ok=sd_service:add_service("Master_1",MasterPod),
...
get_info_test()->    
    ...
    [{"pod_master_1",pod_master_1@asus}]=sd_service:master_pods(), % pod_master_id@Host
